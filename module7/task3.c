...
// Enter new values
void UpdatePoint(int* x, int* y); //pass by value
// Main Function
int main()
{
    //int point[dim];
...
void UpdatePoint(int* xa, int* ya)
{
    ...
    scanf("%d", xa); // when using address dont use "&" adress operator 
    printf("Enter your y - coordinate\n");
    scanf("%d", ya); // when using address dont use "&" adress operator 
    return;
}
